...
const sections = [
  ...
  },
  {
    ...
    content: `
    • Currently building Atlascope, a real-time global crisis tracker with LLM-assisted search and geospatial trend analysis. Stack includes Celery, FastAPI, LangChain, Redis, PostgreSQL, and Mapbox.
